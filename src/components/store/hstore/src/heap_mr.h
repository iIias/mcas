...
public:
	...
	explicit heap_mr(
		...
		: heap_mr(debug_level, plugin_path, dax_manager, id, backing_file, iov_addl_first_, iov_addl_last_, ase, aspd, aspk, asx)
	{
	}
	...
	void free(persistent_t<void *> &p, std::size_t sz, std::size_t alignment);
